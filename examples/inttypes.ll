...
@.str.1 = private unnamed_addr constant [17 x i8] c"%d %ld %u %u %u\0A\00", align 1
...
entry:
  ...
  %calltmp1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i16 5, i64 10, i16 2, i16 15, i16 7)
  %calltmp2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), double 0x4020666666666666)
  ret i32 0
}
